[ch [title Version 2.1.0 2021-09-09]

    [ch [title Bug Fixes]

        [list
            [el The [c id] attribute for nodes [c title] and [c subtitle] is now correctly rendered in HTML.]
            [el All errors are now displayed in OS err.]
        ]
    ]
